...
//
//    @Override
//    public Optional<Cartdetails> getCartDetailById(Integer cartDetailId) {
//        return cartDetailsRepository.findById(cartDetailId);
//    }
//
//    @Override
//    @Transactional
//    public Cartdetails createCartDetail(Cartdetails cartDetail) {
//        return cartDetailsRepository.save(cartDetail);
//    }
//
//    @Override
//    @Transactional
//    public Cartdetails updateCartDetail(Integer cartDetailId, Cartdetails cartDetail) {
//        if (cartDetailsRepository.existsById(cartDetailId)) {
//            cartDetail.setCartDetailId(cartDetailId);
//            return cartDetailsRepository.save(cartDetail);
//        }
